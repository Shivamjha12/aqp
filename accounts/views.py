...
from accounts.forms import *
from anyquestionpaper import settings
    ...
    def post(self, request, *args, **kwargs):
        ...
        if response.status_code == 302:
            ...
            try:
                ...
                form.add_error('', 'Error Occured In Sending Mail, But you can login with credentials')
...
def login(request):
    if request.method == 'POST':
       ...
       user1 = CustomUser.objects.get(email=username)
       print(user1.is_active)
       
       if user is not None and user1.is_active==True:
           auth_login(request, user)
           return redirect('/')
       if user1.is_active!=True:
           messages.info(request, 'You not activated your account, check your registrated email to activate your account')

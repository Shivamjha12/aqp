    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', models.IntegerField(default='Null', unique=True, verbose_name='phone')),
                ...
                ('type', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Teacher', 'TEACHER'), ('Student', 'STUDENT')], default=[], max_length=15, null=True)),
